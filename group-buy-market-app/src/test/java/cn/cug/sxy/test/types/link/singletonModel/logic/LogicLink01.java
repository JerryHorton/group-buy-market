...
@Service
public class LogicLink01 extends AbstractLogicLink<String, DefaultSingletonLogicLinkFactory.DynamicContext, String> {

    @Override
    public String apply(String requestParameter, DefaultSingletonLogicLinkFactory.DynamicContext dynamicContext) {
        dynamicContext.setCode("001");
        dynamicContext.setInfo("001");
